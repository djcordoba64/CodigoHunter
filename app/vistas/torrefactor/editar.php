...
<section class="">
    <div class="woocommerce">
      ...
      <form class="" action="<?php echo RUTA_URL;?>/DatosTorrefactor/editar/<?php echo $datos['iddatosTorrefactor'] ?>" method="POST">
        <h2>TORREFACTOR</h2>  
        <div class="container">
          <div class="row">
          <div class="col-md-7">
            ...
            <div class="col-md-12">
              <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <label for="mermaTrilla" class="">Enfriar<span  style="color: #b89d64;font-size:20px"> </span><abbr class="required" title="required">*</abbr></label>
                  <div class="quantity">                  
                    <input type="number" name="enfriar"  min="1"  step="1" value="<?php echo isset($datos['enfriar'])? $datos['enfriar'] : '';?>" required>
                  </div>
              </div>
            </div>
