...
<div class="container">
  ...
  <div class="well well-sm">    
    <div class="row">
      <div class="col-md-12">                           
        <form class="contact-form" action="<?php echo RUTA_URL;?>/DatosTorrefactor/registrar_datos/" method="POST">
          <div class="row">               
              ...
              <div class="col-md-12" >
                <div class="col-md-6">
                  <p>
                    ...
                    <input class="contact-input" type="number" min="1" required  name="enfriar" value=""/>
                  </p>
                </div>
