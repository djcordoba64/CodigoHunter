...
<section class="">
    <div class="woocommerce">
      ...
      <form class=""  action="<?php echo RUTA_URL;?>/DatosLaboratorio/editar/<?php echo $datos['iddatosLaboratorio']?>""  method="POST">
        <h2>LABORATORIO #2</h2>  
        <div class="container">
          <div class="row">
          <div class="col-md-7">
            ...
            <div class="col-md-12">
              <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <label for=perfildeTaza2" class="">Perfil de taza<span  style="color: #b89d64;font-size:20px"> </span><abbr class="required" title="required">*</abbr></label>
                  <div class="quantity">                  
                    <input type="number" name="perfildeTaza2"  min="1"  step="1" value="<?php echo isset($datos['perfildeTaza2'])? $datos['perfildeTaza2'] : '';?>" required>
                  </div>
              </div>
            </div>
