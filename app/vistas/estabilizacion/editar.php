...
<div class="container">
  <div class="col-md-12">
    <h2>Estabilización del café</h2>
  </div>
  <div class="well well-sm">    
    <div class="row">
      <div class="col-md-12">                           
        <form class="contact-form" action="<?php echo RUTA_URL;?>/DatosEstabilizacion/editar/<?php echo $datos['iddatosEstabilizacion']?>" method="POST">
          <div class="row">               
            <div class="col-md-6" style="background-color:#fff">
              ...
              <div class="col-md-12" >
                <div class="col-md-6">
                  <p>
                    <label for="estabilizacion" class="">estabilización</label>
                    <input class="contact-input" type="number" min="1" required  name="estabilizacion" value="<?php echo $datos['estabilizacion'] ?>"/>
                  </p>
                </div>              
              </div>
