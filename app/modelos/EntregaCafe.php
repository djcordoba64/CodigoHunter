...
class EntregaCafe 
{
	...
	public function obtenerCafes_Facturainforme($idRecepcion){
		$this->db->query("SELECT c.*,t.created_at as FechaTrilla,t.mallas,t.pesoCafeVerde,t.mermaTrilla,e.mermaTueste,e.fechaHora as FechaTueste from estadostorrefaccion as e inner JOIN datostrilla as t on t.idcafe= e.idcafe INNER join cafes as c on c.idcafe =t.idcafe where c.idRecepcion=:idRecepcion  and e.codigoEstado='GTF'");	
